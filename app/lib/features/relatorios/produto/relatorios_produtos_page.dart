...
import 'package:gr/features/relatorios/produto/produto_produtos_controller.dart';
...
class RelatoriosProdutosPage extends StatefulWidget {
  const RelatoriosProdutosPage({Key? key}) : super(key: key);
  @override
  State<StatefulWidget> createState() {
    return RelatoriosProdutosState();
  }
}

class RelatoriosProdutosState extends State<RelatoriosProdutosPage> {
  final RelatoriosProdutosController controller = RelatoriosProdutosController();
  bool notInited = true;
  bool loading = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text('Relatorios de produtos'),
      ),
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: ListTile(
              ...
              title: Center(
                child:  Text(
                  "Produtos (${controller.vendas.length})",
                  style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),
                ),
              ),
              subtitle:listagemDeProdutos(context)
          ),
        ),
      ),
    );
  }
  Widget listagemDeProdutos(BuildContext context){
      ...
      child: Card(
          ...
          child: Padding(
              ...
              child: ListTile(
                  onTap: () { },
                  title:  Center(
                    child: Text("Produtos por clientes(${controller.vendasPorCliente.length})",
                        style: TextStyle( fontSize: 15, fontWeight: FontWeight.bold)),
                  ),
      ...
      child: Card(
          ...
          child: Padding(
              ...
              child: ListTile(
                  onTap: () { },
                  title:  Center(
                    child: Text("Produtos por utilizador(${controller.vendasPorUtilizador.length})",
                        style: TextStyle( fontSize: 15, fontWeight: FontWeight.bold)),
                  ),
                  subtitle: SingleChildScrollView(
                    physics: const AlwaysScrollableScrollPhysics(),
